...
public class RemoveDuplicateLetters {
    ...
    public static void main(String[] args) {
        String str2 = "cbacdcbcdkfhjesjkmgporgjepoighjeoirhngiobkdrnsigodrnsognerongeryrtuhjfgcjghjhkgheujsrhtgouiesrhgui" +
                "oershgorhesndogbjdriophjgbniopedrjnmgoiverjmhgbnmrtdonmhopiersndiognersoipnhgbopersdneovmreovimiedrngbvjndsfr" +
                "iougnbhrtdhngfopiuhrswnoifjsepoifjkmpowerhjgoiesrhtgiouerhsnofgiehrdng" +
                "dtgfdthdhfdjyuopqwieopwquiropqweuroiwehotrhjweiohgfohdvhdfiohbvnidufbniuenuignsedr" +
                "fokgbnokdfgnovbidhrogiphersiophgfiowershzfoewsnzofcnsiozudebhgfviudrxhbgupisdozngviszbhnuifniweanfcvnewipngvpiwusabngvuijwosnvpsneshg" +
                "gdrtjygukuiluihloigujersngpvoeinusropuivgneropsnvbpoeirsuvpouresupgvnergspuognfvupoesngupwepgbwe" +
                "oershgorhesndogbjdriophjgbniopedrjnmgoiverjmhgbnmrtdonmhopiersndiognersoipnhgbopersdneovmreovimiedrngbvjndsfr" +
                "iougnbhrtdhngfopiuhrswnoifjsepoifjkmpowerhjgoiesrhtgiouerhsnofgiehrdng" +
                "dtgfdthdhfdjyuopqwieopwquiropqweuroiwehotrhjweiohgfohdvhdfiohbvnidufbniuenuignsedr" +
                "fokgbnokdfgnovbidhrogiphersiophgfiowershzfoewsnzofcnsiozudebhgfviudrxhbgupisdozngviszbhnuifniweanfcvnewipngvpiwusabngvuijwosnvpsneshg" +
        ...
        System.out.println(removeDuplicateLetters.removeDuplicateLetters2(str2));
